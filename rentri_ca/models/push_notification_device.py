...
class PushNotificationDevice(BaseModel):
    ...
    notification_callback_uri: Annotated[str, Field(min_length=1, strict=True)]
    notification_callback_parameters: Dict[str, StrictStr]
    __properties: ClassVar[List[str]] = ["identifier", "notification_callback_uri", "notification_callback_parameters"]
