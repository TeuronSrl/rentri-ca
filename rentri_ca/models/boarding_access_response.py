...
class BoardingAccessResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["identificativo_soggetto", "denominazione_soggetto", "num_iscr_operatore", "num_iscr_sito", "nome_sito"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.denominazione_soggetto is None and "denominazione_soggetto" in self.model_fields_set:
