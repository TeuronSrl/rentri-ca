...
class SignatureFormats(BaseModel):
    ...
    SignatureFormats
    """ # noqa: E501
    formats: Optional[List[StrictStr]] = Field(default=None, description="Elenco dei formati di firma supportati dal servizio.")
    envelope_properties: Optional[List[List[StrictStr]]] = Field(default=None, description="Elenco delle proprietà riguardanti la busta firmata.")
    __properties: ClassVar[List[str]] = ["formats", "envelope_properties"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.envelope_properties is None and "envelope_properties" in self.model_fields_set:
